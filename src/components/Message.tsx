...
export const MessageComponent: React.FC<MessageProps> = ({ role, content, formattedContent }) => {
  ...
  const displayContent = isUser ? content : (formattedContent || renderMarkdown(content));
